...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `peachesdb`.`customer` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `peachesdb`.`address` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `peachesdb`.`category` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `peachesdb`.`product` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `peachesdb`.`shoppingCart` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `peachesdb`.`shipping` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `peachesdb`.`order` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `peachesdb`.`cartItem` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `peachesdb`.`payment` ;
